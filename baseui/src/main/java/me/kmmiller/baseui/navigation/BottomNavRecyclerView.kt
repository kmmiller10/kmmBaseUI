    ...
    private inner class HorizontalGridLayoutManager(
        ...
        private fun spanLayoutSize(layoutParams: RecyclerView.LayoutParams): RecyclerView.LayoutParams {
            if(orientation == LinearLayoutManager.HORIZONTAL) {
                layoutParams.width = (horizontalSpace / ceil(itemCount.toDouble() / spanCount)).roundToInt()
            } else if(orientation == LinearLayoutManager.VERTICAL) {
                layoutParams.height = (verticalSpace / ceil(itemCount.toDouble() / spanCount)).roundToInt()
            }
            return layoutParams
        }
